...
int D3D9Init(HWND hWnd)
{
   ...
   */
	...
	*/
	...
	dx_Params.BackBufferWidth = clientWidth;
	//dx_Params.BackBufferWidth = windowWidth; tämä on väärin 
	dx_Params.BackBufferHeight = clientHeight;
	//dx_Params.BackBufferWidth = windowWidth; väärin liian ylhäällä
	...
	*/
	...
	D3DXCreateFont(dx_Device, 14, 0, FW_LIGHT, 1, false, DEFAULT_CHARSET, OUT_DEVICE_PRECIS, ANTIALIASED_QUALITY, DEFAULT_PITCH, "Calibri", &dx_FontCalibri);
